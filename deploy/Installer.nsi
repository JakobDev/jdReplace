...
Section
    ...
    WriteRegStr SHCTX "Software\Classes\Directory\shell\${APPNAME}" "" "Open with ${APPNAME}"
    WriteRegStr SHCTX "Software\Classes\Directory\shell\${APPNAME}" "Icon" "$\"${APPBIN}$\""
    WriteRegStr SHCTX "Software\Classes\Directory\shell\${APPNAME}\command" "" "$\"${APPBIN}$\" $\"%1$\""
...
Section "Uninstall"
    ...
    DeleteRegKey SHCTX "Software\Classes\Directory\shell\${APPNAME}"
